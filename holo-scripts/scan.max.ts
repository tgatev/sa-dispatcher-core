...
async function run() {
  ...
  sduProcessor.startListener(); // Start listening for SDU changes - update chances in real time when new SDU is found or lost
  // // dispatcher.sageFleetHandler.getFleetAccount()
  // /** Provide pointer reference to handlers */
  // let minChance = 0.15;
  // let targetSector = new Coordinates(22, 8);
  // let saveBase = new Coordinates(44, 10); // MRZ-23
  // let fleetsScanArray = new Map<string, iScanArrayElement>();
  // for (let i = 1; i <= 7; i++) {
  //   if (i >= 4) {
  //     break;
  //     minChance = 0.1;
  //     saveBase = new Coordinates(13, 37); // MRZ-21
  //     targetSector = new Coordinates(12, 25);
  //   }
