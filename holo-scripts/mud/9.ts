...
import { ProcessHolosim as Process, SageGameHandler, argv } from "../../src/holoHandlers/HolosimMintsImporter";
...
async function run() {
  const saveStarbaseName = "mrz9"; // ust1 ust2 ust3 ust4 ust5 - mrz21
