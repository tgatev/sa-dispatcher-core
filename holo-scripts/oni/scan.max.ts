...
async function run() {
  ...
  let minChance = 0.12;
  let targetSector = new Coordinates(-30, 20);
  ...
  //     // Center point of area
  //     targetSector: targetSector,
  //     // scanSector: new Coordinates(23, 8),
  ...
  //     // Center point of area
  //     targetSector: targetSector,
  //     scanSector: new Coordinates(22, 7),
  ...
  //     // Center point of area
  //     targetSector: targetSector,
  //     scanSector: new Coordinates(22, 9),
  ...
  //   } as iScanConfig,
  // } as iScanArrayElement);
  // fleetsScanArray.set("s4", {
  //   fleetName: "s4",
  //   saveStarbase: new Coordinates(40, 30),
  //   // saveStarbase: new Coordinates(25, 14),
  //   scanConfig: {
  //     stopOnRefill: false,
  //     // Min Percent for scanning
  ...
  //     // Center point of area
  //     targetSector: targetSector,
  //     scanSector: new Coordinates(21, 22),
  ...
  //     // Center point of area
  //     targetSector: targetSector,
  //     scanSector: new Coordinates(26, 22),
  ...
  scanProcess._fuelPercentToForceStarbaseOrientation = 0.3;
