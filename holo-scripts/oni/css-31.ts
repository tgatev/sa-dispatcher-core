...
async function run() {
  const saveStarbaseName = "oni1"; // ust1 ust2 ust3 ust4 ust5 - mrz21
  ...
  await buildScenario(
    ...
    "mrz31",
    {
      ...
      transportToMiningBase: [
        { resourceName: "ammunitions", percent: 0.15 },
        { resourceName: "toolkit", percent: 0.15 },
        { resourceName: "fuel", percent: 0.7 },
      ],
