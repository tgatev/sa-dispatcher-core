...
export async function run(repeat: number | undefined = undefined) {
  ...
  await Process.buildAndAppendActions(proc, "hydrogen", "ust1", {
    ...
    pathToMiningStarbase: [new Coordinates(32, 21), new Coordinates(33, 22), new Coordinates(40, 29), new Coordinates(40, 30)],

    transportToSafeStarbase: [{ resourceName: "aerogel", percent: 1 }],
    pathToSafeStarbase: [new Coordinates(33, 23), new Coordinates(32, 22), new Coordinates(25, 15), new Coordinates(25, 14)],
    crewToSaveBase: "max",
  });
