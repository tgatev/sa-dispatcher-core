...
async function run() {
  ...
  fleetsScanArray.set("RED's Scan Fleet", {
    fleetName: "RED's Scan Fleet",
  ...
  scanProcess._sectorDefaultChance = minChance * 0.9; // predicted SDU chance for sectors without data from SDU Parser
  ...
  scanProcess._waitBeforeMove = 7.5 * 60; // 4 minutes - after cooldown expire waite sector chance to rise up
