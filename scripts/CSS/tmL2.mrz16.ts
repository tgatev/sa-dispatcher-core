...
process.env["TRANSACTION_PRIORITY_FEE_INCREASE_STEP"] = "6000";
process.env["TRANSACTION_PRIORITY_FEE_INCREASE_BASE_FEE"] = "500";
...
async function run() {
  ...
  let pa = await proc.fetchFleetAccount();
  await buildScenario(proc, "titanium_ore", "mrz16", {
    ...
    transportToMiningBase: [
      { resourceName: "ammunitions", percent: 1 },
      // { resourceName: "fuel", percent: 1 },
      // { resourceName: "ammunitions", percent: 0.2 },
