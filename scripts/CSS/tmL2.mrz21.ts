...
async function run() {
  ...
  await buildScenario(proc, "hydrogen", "mrz21", {
    miningTimes: 0,
    movementMode: "Hybrid",
    subwarpDistance: 2,
    fuelTankToSaveStarbase: true,
    transportToMiningBase: [{ resourceName: "food", percent: 1 }],
    transportToSafeStarbase: [{ resourceName: "electronics", percent: 1 }],
    // pathToMiningStarbase: [new Coordinates(33, 23), new Coordinates(32, 22), new Coordinates(25, 15), new Coordinates(25, 14)],
