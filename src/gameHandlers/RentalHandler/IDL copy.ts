  ...
  instructions: [
    {
      ...
      docs: ["Allows a borrower to accept a rental by providing funds and specifying duration."];
      ...
      accounts: [
            ...
            seeds: [
              {
                ...
                value: [114, 101, 110, 116, 97, 108, 95, 97, 117, 116, 104, 111, 114, 105, 116, 121];
              }
            ];
          };
        },
...

        {
          ...
          docs: ["Referral token account - defaults to system program if no referral"];
...

    {
      ...
      docs: ["Cancels an ongoing rental before its scheduled end, marking it as canceled for repayment logic."];
...

    {
      ...
      docs: ["Closes an existing rental contract, preventing further rentals."];
      ...
      accounts: [
...

        {
          ...
          docs: ["Fleet owner's associated token account (optional)."];
...

        {
          ...
          docs: ["Rental token escrow account (tracked under current_rental_state)."];
...

        {
          ...
          docs: ["Active rental state, if any."];
...

    {
      ...
      docs: ["Closes a rental after its duration has ended, removes it from the contract."];
...

    {
      ...
      docs: ["Creates a new rental contract, defining the rental terms such as rate, duration, and payment frequency."];
...

    {
      ...
      docs: ["Handles recurring rental payments via an automated thread."];
      ...
      accounts: [
...

        {
          ...
          docs: ["Referral token account - optional, can be any valid token account"];
...

    {
      ...
      docs: ["Resets a rental in the event of an early cancellation or contract ending."];
  ...
  types: [
    {
      ...
      docs: ["The clock object, representing a specific moment in time recorded by a Solana cluster."];
            ...
            fields: [
              {
                ...
                docs: ["The schedule in cron syntax. Value must be parsable by the `solana_cron` package."];
  ...
  constants: [
    {
      ...
      docs: ["Global seed prefix for PDAs in the program."];
...
export declare const FLEET_RENTAL_IDL: FleetRentalIdl;
