export type Cargo = {
      ...
      accounts: [
        ...
        },
        {
          ...
          docs: [
            ...
            "If the token account belongs to a registered Cargo Type then this account must be a valid Cargo Type",
            "However, to allow closing token account that are not valid Cargo this is an unchecked account"
          ];
        },
        {
          name: "mint";
      ...
      accounts: [
        {
          ...
          isMut: false;
          isSigner: false;
          docs: ["The cargo permissions [`Profile`](Profile).", "Is going to act as the authority for the new definition."];
        },
        {
          name: "funder";
          isMut: true;
  ...
  accounts: [
    ...
    },
    {
      ...
      docs: ["A definition of cargo stats."];
      type: {
        kind: "struct";
        fields: [
          {
  ...
  types: [
    {
      ...
      type: {
        ...
        fields: [
          {
            name: "keyIndex";
            docs: ["the index of the key in the cargo permissions profile"];
            type: "u16";
          },
          {
            name: "newValues";
