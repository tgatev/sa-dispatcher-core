export type Sage = {
  ...
  instructions: [
    ...
    {
      name: "adminDepositCargoToStarbase";
      accounts: [
        {
          name: "starbaseAndStarbasePlayer";
          accounts: [
        ...
        },
        {
          ...
          isMut: true;
          isSigner: false;
          docs: ["The destination cargo pod, owned by `starbase_player`"];
        },
        {
          name: "cargoType";
          isMut: false;
        ...
        },
        {
          ...
          isMut: true;
          isSigner: false;
          docs: ["The source token account - owned by the admin key"];
        },
        {
          name: "tokenTo";
          isMut: true;
      ...
      args: [
        {
          name: "input";
          type: {
            defined: "AdminDepositCargoToStarbaseInput";
          };
        },
      ];
    },
  ...
  types: [
    ...
    {
      name: "AdminDepositCargoToStarbaseInput";
      docs: ["Struct for data input to `AdminDepositCargoToStarbase`"];
      type: {
        kind: "struct";
        fields: [
          {
